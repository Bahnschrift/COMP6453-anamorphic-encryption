...
An implementation of Anamorphic ElGamal and Cramer-Shoup encryption schemes in Rust as per https://eprint.iacr.org/2023/249.pdf.
...
After cloning, this documentation can be viewed in the web browser with `cargo doc --open`, or in `./target/doc/anamorphic_encryption/index.html` after running `cargo doc`.
